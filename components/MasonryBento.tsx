    ...
    <section className="py-8 sm:py-12 bg-white border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-2.5 lg:gap-3 items-stretch">
          ...
          <Link
            href="/products"
            className="group relative block w-full h-[520px] md:h-auto min-h-[520px] md:min-h-[640px] lg:min-h-[680px] rounded-none overflow-hidden bg-black border border-slate-200"
          >
            <Image
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 px-6 py-2.5 bg-black text-white text-[11px] font-bold uppercase tracking-[0.2em] shadow-md whitespace-nowrap rounded-none group-hover:bg-[#2D8F7A] transition-colors duration-300">
          ...
          <div className="flex flex-col gap-2 sm:gap-2.5 lg:gap-3 justify-between">
            ...
            <div className="w-full h-[260px] sm:h-[300px] md:h-[310px] lg:h-[334px] rounded-none bg-white border border-slate-200 p-8 flex flex-col items-center justify-center text-center space-y-4">
              ...
              <a
                ...
                className="mt-1 px-8 py-3 bg-black text-white text-xs font-bold uppercase tracking-[0.2em] hover:bg-[#2D8F7A] transition-colors duration-200 rounded-none shadow-sm"
              >
                SHOP NOW
              </a>
            </div>
