    ...
    <section className="py-20 bg-white border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Block 1: Serum */}
          <div className="group relative rounded-2xl overflow-hidden border border-slate-200 bg-[#f9faf9] hover:border-[#419a85] transition-all duration-300 flex flex-col">
